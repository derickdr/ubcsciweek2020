            ...
            <div class='schedule-container'>
                <div class='schedule-row'>
                    <div class='monday-container'>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>Operation Stone-Seeker (virtual escape room)</h1>
                            <h2 class='event-details'>Time: 11:00pm-4:00pm PST</h2>
                            <h2 class='event-details'>Where: TBA</h2>
                        </div>
                        <div class='day-content'>
                            <h1 class='event-name'>(Yo)galactic Stretching (yoga session)</h1>
                    ...
                    <div class='tuesday-container'>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>Bob Ross Painting (painting session w/ AMS Paint Club)</h1>
                ...
                <div class='schedule-row'>
                    <div class='wednesday-container'>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>“Catch a Bullet” Journaling (bullet journaling w/ Alex from @lexiesdesk)</h1>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>Megamind Trivia (trivia night w/ Astronomy club)</h1>
                    ...
                    <div class='thursday-container'>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>Clubs League (clubs day)</h1>
                ...
                <div class='schedule-row'>
                    <div class='friday-container'>
                        ...
                        <div class='day-content'>
                            <h1 class='event-name'>Serving Up Justice with Inga Lam (cooking session)</h1>
                            <h2 class='event-details'>Time: TBA</h2>
                            <h2 class='event-details'>Where: <a href='https://zoom.us/j/93135322512'>Zoom</a></h2>
                        </div>
                        <div class='day-content'>
                            <h1 class='event-name'>Galactical Idol (UBC Science talent show)</h1>
                            <h2 class='event-details'>Time: TBA</h2>
                            <h2 class='event-details'>Where (location of all videos): <a href='https://www.youtube.com/channel/UC-3akI0PgZVdoONZtOpVZ0A'>Zoom</a></h2>
                        </div>
                        <div class='panel3'></div>
                    </div>
                </div>
